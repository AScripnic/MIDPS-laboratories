...
var _contentTable = __webpack_require__(128);
...
var ContentTableDirective = function () {
  function ContentTableDirective($state) {
  ...
  _createClass(ContentTableDirective, [{
    key: 'openBoard',
    value: function openBoard(boardId) {
      this.state.go('board', { boardId: boardId });
    }
  }]);
...
angular.module(_name2.default).directive('contentTable', function () {
  return {
    ...
    controllerAs: 'table',
    template: _contentTable2.default
  };
});
...
var _createThread = __webpack_require__(129);
...
angular.module(_name2.default).directive('post', [function () {
  return {
    restrict: 'E',
    controller: Post,
...
var _threadPost = __webpack_require__(131);

var _threadPost2 = _interopRequireDefault(_threadPost);
...
exports.AbstractThread = undefined;
...
var AbstractThread = exports.AbstractThread = function () {
  function AbstractThread(thread) {
    _classCallCheck(this, AbstractThread);
...
var PostModel = exports.PostModel = function () {
...
exports.ThreadPreviewModel = undefined;
...
var _AbstractThread2 = __webpack_require__(121);

var _PostModel = __webpack_require__(122);
...
var ThreadPreviewModel = exports.ThreadPreviewModel = function (_AbstractThread) {
  _inherits(ThreadPreviewModel, _AbstractThread);

  function ThreadPreviewModel() {
    var _ref;

    _classCallCheck(this, ThreadPreviewModel);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = ThreadPreviewModel.__proto__ || Object.getPrototypeOf(ThreadPreviewModel)).call.apply(_ref, [this].concat(args)));

    _this.initializePosts();
    return _this;
  }
  ...
  _createClass(ThreadPreviewModel, [{
    key: 'initializePosts',
    value: function initializePosts() {
      this.posts = [];
  ...
  return ThreadPreviewModel;
}(_AbstractThread2.AbstractThread);
...
var _angularUiRouter = __webpack_require__(112);
...
angular.module(_name2.default, [_angularUiRouter2.default, _ngFileUpload2.default]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_index__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_scss_main_scss__ = __webpack_require__(111);
...
var ThreadService = function () {
  function ThreadService(upload, http) {
...
angular.module(_name2.default).service('threadService', ['Upload', '$http', function () {
  for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
    args[_key] = arguments[_key];
  }

  return new (Function.prototype.bind.apply(ThreadService, [null].concat(args)))();
}]);
